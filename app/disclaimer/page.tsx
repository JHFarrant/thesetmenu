        ...
        <div className="flex flex-col flex-grow justify-center">
          <Card href="#">
            ...
            <p className="font-normal text-gray-700 dark:text-gray-400">
              ...
              strive to provide accurate and up-to-date information, but we make
              ...
              connection with, the use of this website. By using this website,
              you acknowledge and agree to the terms stated in this disclaimer.
            </p>
          </Card>
        </div>
      </div>
